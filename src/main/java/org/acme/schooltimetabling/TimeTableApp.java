...
import org.acme.matnrtabling.MatnrTableApp;
...
public class TimeTableApp {
    ...
    private static MatnrTableApp matnrTableApp = new MatnrTableApp();
    ...
    public static TimeTable generateDemoData() {
        ...
        List<Room> roomList = new ArrayList<>(7);
        ...
        lessonList.add(new Lesson(id++, "TEST", "YK", "9th grade"));
        lessonList.add(new Lesson(id++, "TEST", "YK", "10th grade"));
